...
본 프로젝트는 원 논문의 full-data 실험을 그대로 재현한 저장소가 아니라,  
**축소 환경에서 SHy 구조와 실행 흐름을 검증하는 데 목적**이 있습니다.
...
즉, SHy는 단순 attention 기반 설명이 아니라,  
**환자별 phenotype 자체를 설명 단위로 사용하는 self-explaining 모델**입니다.
...
본 프로젝트에서 대표 결과는 **50 epoch 기준 평균 결과**를 사용합니다.

### MIMIC-III (50 epoch, 5 runs)

| Metric | Value |
|--------|-------|
| best Recall@10 | 0.2199 ± 0.0413 |
| best Recall@20 | 0.2844 ± 0.0399 |
| best nDCG@10 | 0.2765 ± 0.0642 |
| best nDCG@20 | 0.2661 ± 0.0512 |
| best test loss | 0.2657 ± 0.0025 |

### MIMIC-IV (50 epoch, 5 runs)

| Metric | Value |
|--------|-------|
| best Recall@10 | 0.2276 ± 0.0253 |
| best Recall@20 | 0.2823 ± 0.0270 |
| best nDCG@10 | 0.4244 ± 0.0276 |
| best nDCG@20 | 0.3926 ± 0.0241 |
| best test loss | 0.2772 ± 0.0017 |
